...
$(window).scroll(function() {
  var bannerBlue = $(".nav_blue").position().top;
  var bannerWhite = $(".nav_white").position().top;
  var bannerBlue2 = $(".nav_white2").position().top;
  var posicionActual = $(document).scrollTop();
  if (posicionActual > bannerBlue - 64) {
    $("nav.menu").removeClass("Blue");
    $("nav.menu").addClass("White");
    $(".cls-1").css({
      "fill": "#3f82f1"
    });
    $(".cls-2").css({
  ...
  if (posicionActual > bannerWhite - 64) {
    $("nav.menu").removeClass("White");
    $("nav.menu").addClass("Blue");
    $(".cls-1").css({
      "fill": "#FEFEFE"
    });
    $(".cls-2").css({
  ...
  //fondos();
  if (posicionActual > bannerBlue2 - 64) {
    $("nav.menu").removeClass("Blue");
    $("nav.menu").addClass("White");
    $(".cls-1").css({
      "fill": "#3f82f1"
